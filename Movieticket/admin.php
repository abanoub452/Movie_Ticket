...
if($_SESSION['role']!= "admin")
{
  ...
  $q="SELECT * FROM `reservation` WHERE status=1"; 
...
<h2 style="text-align: center;">Table Headers</h2>

<p style="text-align: center;">Use the TH element to define table headers.</p>
...
<tbody>
   ...
   
    {
        ...
        <tr>
            ...
            ?></td>  
            <td>
                <a href="adm.php?id=<?php echo($row['id']); ?>&st=2">Accepted</a>
                <a href="adm.php?id=<?php echo($row['id']); ?>&st=0">Deny</a>
            </td>
